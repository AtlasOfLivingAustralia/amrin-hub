...
Comment out any testing line for amrin.ala.org.au in your /etc/hosts file and add the following line:

```
52.63.44.128 amrin.ala.org.au
```

Then deploy to that machine using the following command, replacing "MY_USER_NAME" with your login username:

```
$ ansible-playbook --user MY_USER_NAME -i ansible-inventories/amrin.ala.org.au ala-install/ansible/amrin-hub-standalone.yml --private-key ~/.ssh/id_rsa -vvvv --sudo --ask-sudo-pass
```
